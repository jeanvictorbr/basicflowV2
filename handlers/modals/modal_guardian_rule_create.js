...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await db.query(
            `INSERT INTO guardian_rules (guild_id, name, trigger_type, trigger_threshold, action_delete_message, action_warn_member_dm, action_punishment, action_punishment_duration_minutes)
             VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
            [
                interaction.guild.id, name, triggerType, threshold,
                actions.includes('DELETAR'), actions.includes('AVISAR'),
        ...
        const menu = generateGuardianRulesMenu(rules);
