// handlers/buttons/mod_dossie_manage.js
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Gera o dossiê em "modo de gerenciamento"
        const dossiePayload = generateDossieEmbed(member, history, notes, interaction, { manageMode: true });
