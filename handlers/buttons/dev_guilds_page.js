...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const settingsResult = await db.query('SELECT guild_id, ponto_status, registros_status, tickets_category, guardian_ai_enabled, roletags_enabled, suggestions_enabled, store_enabled FROM guild_settings');
        ...
        switch(sortKey) {
            ...
            case 'expiry': allGuildData.sort((a, b) => (a.premium_expires_at || 0) - (b.premium_expires_at || 0)); break;
